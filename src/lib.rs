...
impl ServiceBackend for CalibreWebBackend {
        ...
        -> BoxFuture<'a, Result<WorkloadSpec, ServiceError>>
    {
        ...
        Box::pin(async move { Err(ServiceError::unimplemented("calibre-web.workload_spec")) })
    }
        ...
        -> BoxFuture<'a, Result<BackupArtifact, ServiceError>>
    {
        ...
        Box::pin(async move { Err(ServiceError::unimplemented("calibre-web.backup")) })
    }

    fn restore<'a>(&'a self, _ep: &'a Endpoint, _from: &'a BackupArtifact)
        -> BoxFuture<'a, Result<(), ServiceError>>
    {
        Box::pin(async move { Err(ServiceError::unimplemented("calibre-web.restore")) })
    }
